...
to setup
  ...
  [ask patches [ set pcolor brown ] ]  ;no treatment

  import-pcolors "Sampaloc.png"
  ;import-pcolors "Circle.png"
  ask patches with [ not shade-of? brown pcolor ] [
  ...
  [
    ...
    set label-color blue - 2
    set parasites 0
    ;if add-infectionarea? [ move-to one-of patches with [pxcor < -1 * infx and pycor > infy and pcolor = blue] ];spatial position of infected
